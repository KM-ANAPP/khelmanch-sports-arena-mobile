  ...
  return (
    <section className="py-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold">Pick a Sport</h2>
      ...
      <div className="overflow-x-auto pb-4 -mx-4 px-4">
        <div className="flex gap-4" style={{ minWidth: "max-content" }}>
          {sports.map((sport, index) => (
            ...
            >
              <Card 
                className={`w-40 cursor-pointer transition-all duration-300 hover:shadow-lg ${
              ...
              >
                <CardContent className="p-4 text-center">
                  ...
                  <div className="space-y-1 text-xs text-muted-foreground">
                    ...
                    <div className="flex justify-between">
                      <span>Events:</span>
                      <span className="font-medium text-primary">{sport.events}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <div className="flex justify-center mt-2">
        <div className="flex space-x-1">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="w-1 h-1 rounded-full bg-muted animate-pulse" style={{ animationDelay: `${i * 0.2}s` }} />
          ))}
        </div>
      </div>
    </section>
