    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-background/80 backdrop-blur-sm p-0 opacity-70 hover:opacity-100 border-primary/20 hover:bg-primary/10"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-primary/10 text-foreground"
        ),
